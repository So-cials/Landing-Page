...
export default function WhySocials() {
  return (
    <section id="why" className="py-24 px-6 bg-foreground text-primary-foreground">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="reveal-stagger space-y-5 mb-12">
          {problems.map((p) => (
            <div key={p.text} className="reveal flex items-center gap-4 border-3 border-primary-foreground/20 rounded-xl p-5 bg-primary-foreground/5">
